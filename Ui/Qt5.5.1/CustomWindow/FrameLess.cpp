/*
CustomWindow is a simple, native and easy to use custom top-level window created by Q
...
_borderWidth(5)
{
	...
	_parent->setWindowFlags(Qt::FramelessWindowHint | Qt::CustomizeWindowHint | Qt::Window);
