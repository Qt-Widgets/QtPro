QPainter painter(this);
	...
	painter.drawRoundRect(QRectF(QPointF(width() - margin*2, margin), QPointF(width(), height() - margin)), 0.0, 0.0);
	// left
	gradient.setStart(left0);
	gradient.setFinalStop(left1);
	painter.setBrush(QBrush(gradient));
	painter.drawRoundRect(QRectF(QPointF(margin*2, margin), QPointF(0, height() - margin)),0.0, 0.0);
	// top
